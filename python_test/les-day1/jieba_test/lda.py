...
import matplotlib
import pandas as pd
from gensim_test import corpora, models, similarities
import gensim_test
import numpy as np
...
# 设置文件路径
dir = "H://tansun//CCB//testdata//"
file_desc = " ".join([dir, 'car.csv'])
stop_word = " ".join([dir, 'stopwords.txt'])

# 定义停用词
stopwords = pd.read_csv(stop_word, index_col=False, quoting=3, sep="\t", names=["stopword"], encoding='utf-8')
...
lda = gensim_test.models.ldamodel.LdaModel(corpus=corpus, id2word=dictionary, num_topics=10)

# 我们查一下第1号分类，其中最常出现的5个词是：
print(lda.print_topic(1, topn=5))

# 我们打印所有10个主题，每个主题显示8个词
